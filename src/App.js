...
import { connect } from 'react-redux';
 class App extends React.Component{
  ...
  let url='http://pandora.unihyr.com/pandora-service/v1/candidate/0f8f0fe1-84ae-43ee-b8d2-1f68af34b614';
    ...
    locationList:resp.data.candidateLocations
    })
    this.props.addSkills({
      locationList:resp.data.candidateSkills
    })
    })
}
componentDidMount(){
  ...
  render(){ 
    ...
    // const location1=this.props.locationList
  return (
<Router>
...
const Home1 = connect(mapHomeStatetoProps,{
  addLocation,addSkills
})(App);
